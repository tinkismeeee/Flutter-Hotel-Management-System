...
class StaffService {
  static const String baseUrl = 'http://143.198.221.127/api/staff';
  ...
  static Future<bool> addStaff({
    ...
    debugPrint('ADD STAFF STATUS: ${response.statusCode}');
    debugPrint('ADD STAFF BODY: ${response.body}');
  ...
  static Future<bool> updateStaff({
    ...
    debugPrint('UPDATE STAFF BODY: ${response.body}');
  ...
  static Future<bool> deleteStaff(int id) async {
    ...
    debugPrint('DELETE STAFF STATUS: ${response.statusCode}');
    debugPrint('DELETE STAFF BODY: ${response.body}');
