...
class HotelServiceService {
  ...
  static Future<bool> addService({
    ...
    debugPrint('ADD SERVICE STATUS: ${response.statusCode}');
    debugPrint('ADD SERVICE BODY: ${response.body}');
  ...
  static Future<bool> deleteService(int id) async {
    ...
    debugPrint('DELETE SERVICE STATUS: ${response.statusCode}');
    debugPrint('DELETE SERVICE BODY: ${response.body}');
