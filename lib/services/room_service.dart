...
class RoomService {
  ...
  static Future<bool> addRoom({
    ...
    debugPrint('ADD ROOM STATUS: ${response.statusCode}');
    debugPrint('ADD ROOM BODY: ${response.body}');
  ...
  static Future<bool> updateRoom({
    ...
    debugPrint('UPDATE ROOM STATUS: ${response.statusCode}');
    debugPrint('UPDATE ROOM BODY: ${response.body}');
  ...
  static Future<bool> deleteRoom(int id) async {
    ...
    debugPrint('DELETE ROOM STATUS: ${response.statusCode}');
    debugPrint('DELETE ROOM BODY: ${response.body}');
